...
const pageHtml = `
    <main>
        ...
        <section
            style="min-height: 100vh; display: flex; align-items: center; position: relative; background: linear-gradient(rgba(255,255,255,0.56), rgba(255,255,255,0.56)), url('/assets/images/about-bg.png'); background-size: cover; background-position: center; text-align: center;  opacity: 1; transform: translateY(0px); transition: opacity 0.6s ease-out, transform 0.6s ease-out;"
            class="visible">
            <div class="container hero-content">
                <span
                    style="text-transform: uppercase; letter-spacing: 2px; font-weight: 600; color: var(--primary-color);">About
                    Shefali Soni</span>
                <h1 style="font-size: 4.5rem; margin-top: 20px; margin-bottom: 25px;">A Gentle Guide on Your <br>Healing
                    Path</h1>
                <p style="font-size: 1.35rem; color: #444; max-width: 800px; margin: 0 auto;  line-height: 1.6;">Helping
                    you find clarity, emotional balance, and inner strength through intuitive guidance and compassionate
                    support.</p>
                <div style="margin-top: 50px;">
                    <span
                        style="font-family: var(--heading-font); font-size: 2rem; color: var(--primary-color);">Shefali
                        Soni</span>
                    <p
                ...
                <div class="grid-2">
                    <div>
                        <span
                            ...
                            Story</span>
                        <h2 style="font-size: 3.2rem; margin-top: 20px; margin-bottom: 30px;">My Journey Into
                            <br>Healing</h2>
            ...
            <div class="container">
                <div style=" margin-bottom: 80px;">
                    <span
                        style="color: var(--primary-color); font-weight: 600; text-transform: uppercase; letter-spacing: 2px;">My
                        Philosophy</span>
                    <h2 style="font-size: 3.2rem; margin-top: 20px; margin-bottom: 30px;">How I Work With You</h2>
        ...
        <section
            ...
            <div class="container">
                <div style=" margin-bottom: 80px;">
                    ...
                    <h2 style="font-size: 3.2rem; margin-top: 20px;">Experience &amp; Training</h2>
                </div>
        ...
        <section
            ...
            <div class="container">
                <span
                    ...
                    to Begin?</span>
                <h2 style="font-size: 3.2rem; margin-top: 20px; margin-bottom: 30px;">Book a Private Session</h2>
